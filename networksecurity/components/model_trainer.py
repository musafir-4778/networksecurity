...
# import dagshub
# dagshub.init(repo_owner='musafir-4778', repo_name='my-first-repo', mlflow=True)

# os.environ["MLFLOW_TRACKING_URI"] ="to be pasted"
# os.environ["MLFLOW_TRACKING_USERNAME"] = "musafir-4778"
# os.environ["MLFLOW_TRACKING_PASSWORD"] = "to be pasted"
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric):
        # mlflow.set_registry_uri("to be pasted")
